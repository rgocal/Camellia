...
public class ProvidersLiveFragment extends MonetFragment {

    private Context mContext;
    private ArrayList<WallpaperDataInfo> wallpaperProviders = new ArrayList<>();

    public static ProvidersLiveFragment newInstance() {
        return new ProvidersLiveFragment();
    }
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        wallpaperProviders = WallpaperProviderData.getLiveWallpaperProviders(mContext);
