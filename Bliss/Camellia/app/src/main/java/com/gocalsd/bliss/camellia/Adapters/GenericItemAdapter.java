...
public class GenericItemAdapter extends RecyclerView.Adapter<GenericItemAdapter.MyViewHolder>  {
    ...
    public GenericItemAdapter(Context context, ArrayList<HashMap<String, String>> list, ItemClickListener clickListener, int primaryColor) {
    ...
    public void onBindViewHolder(@NonNull final MyViewHolder holder, @SuppressLint("RecyclerView") final int position) {
        holder.name.setText(getItemLabel(position));
    ...
    public String getItemLabel(int position){
        return mDataSet.get(position).get("creation_item");
    }

    public String getItemIcon(int position){
        return mDataSet.get(position).get("creation_icon");
    }
